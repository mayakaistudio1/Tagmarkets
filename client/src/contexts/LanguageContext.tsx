...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'scheduleSubtitle': 'Еженедельные живые Zoom-созвоны с нашими экспертами. Бесплатно и без регистрации.',
    'scheduleAll': 'Все',
    'scheduleUhr': '',
    'scheduleExpect': 'Что тебя ждёт:',
    'scheduleJoinZoom': 'Присоединиться к Zoom',
    'scheduleNoEvents': 'Нет мероприятий в этой категории.',
  ...
  de: {
    ...
    'home.mariaGreeting': 'Hallo! Ich bin Maria, deine JetUP‑Assistentin. Ich erkläre dir das Ökosystem und helfe dir weiter. Was möchtest du wissen?',
    'home.mariaOnline': 'Maria online',
